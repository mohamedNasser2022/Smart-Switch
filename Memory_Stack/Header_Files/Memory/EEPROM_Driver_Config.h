...
#define EEPROM_Driver_Read_From_Hardware(WORD_ADDRESS,QUEUE_DATA,NUMBER_OF_BYTE_TO_READ)			  Reading_From_I2C_Perpherial_1((u8)((EEPROM_ADDRESSES | (WORD_ADDRESS >> 7) & (0xFE))),QUEUE_DATA,NUMBER_OF_BYTE_TO_READ,Notification_Handler_I2C)
