...
typedef Array_Of_Queue_5 EEROM_Queue;
#define EEPROM_Queue_Pop(QUEUE_POINTER,POINTER_DATA)  Queue5_Pop(QUEUE_POINTER,POINTER_DATA)
#define EEPROM_Queue_Push(QUEUE_POINTER,DATA)  		Queue5_Push(QUEUE_POINTER,DATA)
#define EEPROM_Queue_Create(QUEUE_POINTER) 			 Queue5_Create(QUEUE_POINTER)
